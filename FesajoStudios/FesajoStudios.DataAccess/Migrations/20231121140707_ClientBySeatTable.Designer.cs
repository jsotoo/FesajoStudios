...
namespace FesajoStudios.DataAccess.Migrations
{
    ...
    [Migration("20231121140707_ClientBySeatTable")]
    partial class ClientBySeatTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FesajoStudios.Entities.SeatXClient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FesajoStudios.Entities.SeatXClient", b =>
                {
                    b.HasOne("FesajoStudios.Entities.Client", "Showing")
                        .WithMany()
                        .HasForeignKey("ClientId")
                        .IsRequired();
