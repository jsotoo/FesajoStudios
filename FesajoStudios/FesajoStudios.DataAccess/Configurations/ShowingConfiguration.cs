    ...
    public class ShowingConfiguration : IEntityTypeConfiguration<Showing>
    {
        public void Configure(EntityTypeBuilder<Showing> builder)
        {
            builder.HasData(new List<Showing>
            {
                ...
                new() { Id = 2, StartDate = new DateTime(2023,12,2,12,0,0), EndDate = new DateTime(2023,12,2,13,30,0), MovieId = 3, TheatherId = 2, State = true  },
                new() { Id = 3, StartDate = new DateTime(2023,11,16,16,5,0), EndDate = new DateTime(2023,11,16,16,5,0), MovieId = 2, TheatherId = 3, State = true  },
                ...
                new() { Id = 7, StartDate = new DateTime(2023,12,4,13,30,0), EndDate = new DateTime(2023,12,4,14,0,0), MovieId = 8, TheatherId = 4, State = true  },
